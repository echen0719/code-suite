...
public class elementGen {
    ...
    public static void main(String[] args) {
        ...
        if (howMany == -1) {
            ...
            System.out.println("Try again. Invalid value found.");
            System.exit(0);
        }
    }
}