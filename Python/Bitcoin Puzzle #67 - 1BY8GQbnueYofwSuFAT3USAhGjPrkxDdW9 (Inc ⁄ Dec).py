...
def up_search():
    for i in range(73786976294838206464, 147573952589676412928):
...
# up_search to start 73786976294838206464 up to 147573952589676412928

def down_search():
        for i in reversed(range(73786976294838206464, 147573952589676412928)):
            private_key = solver.parse.secret_exponent(i).address()
            print("{}. {}".format(i, private_key))
...
# down_search to start at 147573952589676412928 down to 73786976294838206464

if int(input("Up (1) or Down (2): ")) == 1:
    up_search()
else:
    down_search()
